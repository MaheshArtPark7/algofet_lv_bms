...
/* #define CAN_CODEGEN_USE_BITS_SIGNAL */
...
/* #define CAN_CODEGEN_USE_SIGFLOAT */
...
/* #define CAN_CODEGEN_USE_DIAG_MONITORS */


/* ------------------------------------------------------------------------- *
  When monitor using is enabled (CAN_CODEGEN_USE_DIAG_MONITORS) and define below
